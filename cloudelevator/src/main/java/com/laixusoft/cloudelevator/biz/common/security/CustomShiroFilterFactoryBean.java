...
import com.laixusoft.cloudelevator.biz.common.security.servlet.CusomShiroHttpServletResponse;
...
/**
 * Created by apple on 14/11/21 下午9:01.
 */
public class CustomShiroFilterFactoryBean implements FactoryBean, BeanPostProcessor {
     ...
     * {@link org.apache.shiro.web.filter.AccessControlFilter} or {@code null} if no value should be assigned globally. The default value
     * is {@code null}.
     *
     * @return the application's login URL to be assigned to all acquired Filters that subclass
     * {@link org.apache.shiro.web.filter.AccessControlFilter} or {@code null} if no value should be assigned globally.
     * @see #setLoginUrl
     */
     ...
     * {@link org.apache.shiro.web.filter.AccessControlFilter}.  This is a convenience mechanism: for all configured {@link #setFilters filters},
     * as well for any default ones ({@code authc}, {@code user}, etc), this value will be passed on to each Filter
     * via the {@link org.apache.shiro.web.filter.AccessControlFilter#setLoginUrl(String)} method<b>*</b>.  This eliminates the need to
     ...
     *                 {@link org.apache.shiro.web.filter.AccessControlFilter} instances.
     * @see org.apache.shiro.web.filter.AccessControlFilter#setLoginUrl(String)
     */
     ...
     * {@link org.apache.shiro.web.filter.authc.AuthenticationFilter} or {@code null} if no value should be assigned globally. The default value
     * is {@code null}.
     *
     * @return the application's after-login success URL to be assigned to all acquired Filters that subclass
     * {@link org.apache.shiro.web.filter.authc.AuthenticationFilter} or {@code null} if no value should be assigned globally.
     * @see #setSuccessUrl
     */
     ...
     * {@link org.apache.shiro.web.filter.authc.AuthenticationFilter}.  This is a convenience mechanism: for all configured {@link #setFilters filters},
     * as well for any default ones ({@code authc}, {@code user}, etc), this value will be passed on to each Filter
     * via the {@link org.apache.shiro.web.filter.authc.AuthenticationFilter#setSuccessUrl(String)} method<b>*</b>.  This eliminates the need to
     ...
     *                   {@link org.apache.shiro.web.filter.AccessControlFilter} instances.
     * @see org.apache.shiro.web.filter.authc.AuthenticationFilter#setSuccessUrl(String)
     */
     ...
     * {@link org.apache.shiro.web.filter.authz.AuthorizationFilter}.  This is a convenience mechanism: for all configured {@link #setFilters filters},
     * as well for any default ones ({@code roles}, {@code perms}, etc), this value will be passed on to each Filter
     * via the {@link org.apache.shiro.web.filter.authz.AuthorizationFilter#setUnauthorizedUrl(String)} method<b>*</b>.  This eliminates the need to
     ...
     *                        {@link org.apache.shiro.web.filter.authz.AuthorizationFilter} instances.
     * @see org.apache.shiro.web.filter.authz.AuthorizationFilter#setUnauthorizedUrl(String)
     */
     ...
     * web application context that implement the {@link javax.servlet.Filter} interface and automatically add them to this filter
     ...
     * {@link org.apache.shiro.web.filter.mgt.FilterChainManager#createChain(String, String)} JavaDoc, where the map key is the chain name (e.g. URL
     ...
     * {@link org.apache.shiro.web.filter.mgt.FilterChainManager#createChain(String, String)} JavaDoc - each property key is an ant URL
    ...
    /**
     * Lazily creates and returns a {@link org.apache.shiro.web.servlet.AbstractShiroFilter} concrete instance via the
     ...
     * <li>{@link #createFilterChainManager() Creates} a {@link org.apache.shiro.web.filter.mgt.FilterChainManager} instance that reflects the
    ...
    /**
     * Inspects a bean, and if it implements the {@link javax.servlet.Filter} interface, automatically adds that filter
     ...
     * {@link org.apache.shiro.web.servlet.AbstractShiroFilter}'s
     * {@link org.apache.shiro.web.servlet.AbstractShiroFilter#setSecurityManager(org.apache.shiro.web.mgt.WebSecurityManager) securityManager} and
     * {@link org.apache.shiro.web.servlet.AbstractShiroFilter#setFilterChainResolver(org.apache.shiro.web.filter.mgt.FilterChainResolver) filterChainResolver}
    ...
    private static final class SpringShiroFilter extends AbstractShiroFilter {
        ...
        /**
         * Returns a new {@link CusomShiroHttpServletResponse} instance, wrapping the {@code orig} argument, in order to provide
        ...
        protected ServletResponse wrapServletResponse(HttpServletResponse orig, ShiroHttpServletRequest request) {
            return new CusomShiroHttpServletResponse(orig, getServletContext(), request);
        }
    }
}